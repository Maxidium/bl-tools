...
A Blender add-on for organizing, accessing, and running Python scripts from the N-Panel (*Scripts not included*).

### Features
* Run Python scripts with a single click.
* Organize scripts into custom categories. 
* Create, import, rename, edit, and delete scripts directly from N-Panel.
...
* Merge mesh objects inside collections.
* Automatically rename objects with custom naming patterns.
* Flatten collection structure.
* Select processed objects.
